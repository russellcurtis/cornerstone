...
$hours_total = 0;
		...
		$invoice_cost_print = "£" . number_format($invoice_cost,2);
				...
				$ts_fee_target_print = "Stage Fee (including profit at " . number_format($ts_fee_target_print,2) . "%)";
	...
	$sql_fee_text = "SELECT ts_fee_text, ts_fee_target FROM intranet_timesheet_fees WHERE ts_fee_id = '$ts_stage_fee' LIMIT 1";
