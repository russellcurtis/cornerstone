...
<?php
	...
	if ($ts_project > 0) {
		$sql = "SELECT * FROM cstone_projects order by proj_num";
	} else {
		$sql = "SELECT * FROM cstone_projects WHERE proj_active = '1' order by proj_num";
	}
...
<?php
	...
	$fee_repeat = NULL;
	$sql2 = "SELECT * FROM cstone_timesheet_fees, cstone_projects WHERE ts_fee_project = proj_id ORDER BY proj_num, ts_fee_time_begin";
