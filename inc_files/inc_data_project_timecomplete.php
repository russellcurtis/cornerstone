...
if ($proj_date_complete > 0) { $date_day = date("j",$proj_date_complete); } else { $date_day = 0; }
if ($proj_date_complete > 0) { $date_month = date("n",$proj_date_complete); } else { $date_month = 0; }
if ($proj_date_complete > 0) { $date_year = date("Y",$proj_date_complete); } else { $date_year = 0; }
...
$count_year = 1;
		...
		print "<p>Day&nbsp;<select name=\"proj_date_complete_day\" class=\"inputbox\">";
...
print "</select>&nbsp;&nbsp;";
		...
		print "Month&nbsp;<select name=\"proj_date_complete_month\" class=\"inputbox\">";
...
print "</select>&nbsp;&nbsp;";
		...
		print "Year&nbsp;<select name=\"proj_date_complete_year\" class=\"inputbox\">";
		print "<option value=\"0\">N/A";
